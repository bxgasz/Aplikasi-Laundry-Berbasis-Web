<div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="modal-form">
    <div class="modal-dialog modal-lg" role="document">
        <form action="@if($outlet != null ) {{ route('outlet.laporan', $outlet->id_outlet) }} @else {{ route('laporan.index') }} @endif" method="get" class="form-horizontal">
            @csrf
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="tanggal_awal" id="tanggal_awal" class="form-control datepicker" required style="border-radius: 0 !important;" value="{{ request('tanggal_awal') }}">
